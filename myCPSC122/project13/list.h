...
The following functions are to be written recursively, either directly or
indirectly: ~List() Print() PrintRev() GetLength()

Notice that there are private member companion functions for all of these. These
should give you a hint as to how to proceed.  The structure of the the recursive
C-String functions in .../github/pauldepalma/CPSC122/I-Recursion should help.

Notice also that there is no length variable among the private member
varialbles.  You may not add one.
*/
